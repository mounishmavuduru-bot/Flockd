...
async function main() {
  ...
  A.conn.reducers.joinRoom({ code: ROOM, name: 'AlphaBird', mode: 'race', color: 0, skin: 'stork' });
  B.conn.reducers.joinRoom({ code: ROOM, name: 'BetaBird', mode: 'race', color: 1, skin: 'stork' });
  await sleep(800);
