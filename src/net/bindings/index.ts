...
const tablesSchema = __schema({
  ...
  favorLedger: __table({
    name: 'favor_ledger',
    indexes: [
      { accessor: 'identity', name: 'favor_ledger_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
      { accessor: 'roomId', name: 'favor_ledger_room_id_idx_btree', algorithm: 'btree', columns: [
        'roomId',
      ] },
    ],
    constraints: [
      { name: 'favor_ledger_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, FavorLedgerRow),
  lobbyPrompt: __table({
    name: 'lobby_prompt',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("tithe", TitheReducer),
